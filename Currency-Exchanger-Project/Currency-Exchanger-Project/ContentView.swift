        ...
        ZStack {
            ...
            VStack {
                ...
                Menu {
                    ...
                    Text(upperFlag).font(.largeTitle)
                }
                }.offset(x: 150, y: 100).foregroundColor(purpleColor)
                ...
                Menu {
                    ...
                    VStack{
                        Image(systemName: "chevron.down").font(.largeTitle)
                        Text(lowerFlag).font(.largeTitle)
                    }
                }.offset(x: 150, y: 159).foregroundColor(purpleColor)
                ...
                Button {
                    ...
                    Image(systemName: "arrow.trianglehead.2.clockwise.rotate.90").font(.largeTitle).offset(x: -80, y: 150).foregroundColor(.white)
                }
